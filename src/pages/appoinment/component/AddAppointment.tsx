...
export default function AddAppointment({
  ...
  function buildPayload(values: CreateAppointmentFormValues): CreateAppointmentPayload {
    return {
      professionalId: values.professionalId,
      ...(values.visitorId ? { visitorId: values.visitorId } : {}),
  ...
  function onSubmit(values: CreateAppointmentFormValues) {
    createAppointment(buildPayload(values))
      .unwrap()
      .then((response) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            <CommonHeader name="Add Appointment" />
          </DialogTitle>
          <DialogDescription>Create a new appointment record.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
