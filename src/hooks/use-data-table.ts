...
import type { DataTableFilterField } from "@/schema-types/data-table.types";
...
export function useDataTable<TData, TValue>({
  ...
  // If you still want to prevent scroll, add this optional line:
  ...
  React.useEffect(() => {
    ...
    navigate(`${pathname}?${createQueryString({...})}`, { replace: true });
